...
//For and unspecified or dust path the below route will be fire. path will be "/admin/anything" then below route will be execute.
//It should be at the end.
admin_route.get('*',function(req,res){  //It will be executed when no other route matches
    res.redirect('/admin')
})
